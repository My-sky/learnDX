...
void Billboard::UpdateScene(float dt)//update the view matrix ; the camera position
{
...
void Billboard::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void Billboard::OnMouseUp(WPARAM	btnState, int x, int y)
{
	ReleaseCapture();
}

void Billboard::OnMouseMove(WPARAM btnState, int x, int y)
{
...
float Billboard::GetHeight(float x, float z) const
{
	return 0.3f*(z*sinf(0.1f*x) + x*cosf(0.1f*z));
}

XMFLOAT3 Billboard::GetNormal(float x, float z) const
{
	//n=(-df/dx,1,-df/dz)
...
void Billboard::CreateHillGeometryBuffers()
{
...
void Billboard::CreateWaveGeometryBuffers()
{
...
void Billboard::CreateBoxGeometryBuffers()
{
...
void Billboard::CreateTreePointLayout()
{
