...
float Crate::GetHeight(float x, float z) const
{
	return 0.3f*(z*sinf(0.1f*x) + x*cosf(0.1f*z));
}

XMFLOAT3 Crate::GetNormal(float x, float z) const
{
	//n=(-df/dx,1,-df/dz)
...
void Crate::CreateHillGeometryBuffers()
{
...
void Crate::CreateWaveGeometryBuffers()
{
...
void Crate::CreateFX()
{
	...
	//compile at build 
	std::ifstream fin("..\\shaders\\Crate.fxo", std::ios::binary);
