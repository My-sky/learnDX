...
TessellationEffect::TessellationEffect(ID3D11Device* device, const std::wstring& filename)
	:Effect(device, filename)
{
	pTessTech = pFX->GetTechniqueByName("Tess");
...
TessellationEffect* Effects::pTessellationFX = 0;
...
void Effects::InitAll(ID3D11Device* device)
{
	...
	pTessellationFX = new TessellationEffect(device, L"../shaders/Tessellation.fxo");
}
