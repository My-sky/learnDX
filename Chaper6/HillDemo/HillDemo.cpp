...
void Hill::UpdateScene(float dt)//update the view matrix ; the camera position
{
...
void Hill::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void Hill::OnMouseUp(WPARAM	btnState, int x, int y)
{
	ReleaseCapture();
}

void Hill::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void Hill::CreateGeometryBuffers()
{
